...
\item[Cruise/Circling orientation]  \label{conf:orientation} This determines how
  ...
  is oriented up. The north arrow symbol points to true north. It is displayed as soon as one display orientation (circling or cruise) is not North Up. The glider symbol 
